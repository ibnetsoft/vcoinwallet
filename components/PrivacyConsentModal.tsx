              ...
              <table className="w-full border-collapse border border-gray-300 text-sm mt-2">
                <thead>
                  <tr className="bg-gray-50">
                    <th className="border border-gray-300 px-4 py-2 text-left font-bold text-gray-900">수집·이용 목적</th>
                    <th className="border border-gray-300 px-4 py-2 text-left font-bold text-gray-900">수집하는 개인(민감)정보의 항목</th>
                    <th className="border border-gray-300 px-4 py-2 text-left font-bold text-gray-900">보유 및 이용기간</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="border border-gray-300 px-4 py-2 align-top text-gray-900">
